...
const int NUM_BINS = 1 >> 13;
const int SAMPLE_RATE = 44100;
const int NOTES_ON_KEYBOARD = 88;
const int TONAL_RESOLUTION_OF_SPEC = 11;

class FrequenciesData {
  String audioFilePath;
  String binOutputFilePath;
  String predictionPath;
  String specImagePath;

  FrequenciesData(
      {this.audioFilePath,
      this.binOutputFilePath,
      this.predictionPath,
      this.specImagePath});
}
...
void generateFrequencyAnalysis(FrequenciesData freqData) {
  // takes the audio file at soundFileName
  // creates a waveform bin file at outputFileName,
  File binFile = File(freqData.binOutputFilePath);

  // initialize an instance of Frequencies using the generated binFile
  Frequencies freq = Frequencies(binFile);

  // generates the predictions array csv at predOutputLocation
  freq.generatePred(freqData.predictionPath);

  // generates the spectrograph png at specOutputLocation
  freq.generateSpec(freqData.specImagePath);
}
